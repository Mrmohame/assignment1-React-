...
<h2 className='text-[2.5rem] text-[#2c3e50] font-bold  uppercase mt-10 mb-1'>conatct section</h2>
   <span className='starDesign2 relative px-5'>
...
<form className="minism:w-[60%] md:w-[50%] mx-auto py-6">
  <div className="relative py-3 z-0 w-full mb-5 group">
  ...
  <button type="submit" className="text-white bg-[#1abc9c] mb-2 focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">send Message</button>
</form>
